...
export function buildDefaultToolProviders(tenantId) {
  return [
    {
...
export function buildDefaultPolicies(tenantId) {
  return [
    {
...
export function renderDefaultSeedSql(tenantId, createdAt) {
