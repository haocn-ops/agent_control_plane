...
- 目前已有 baseline onboarding bundle、deploy/runtime workflows、GitHub environments 與 repository variables，但仍缺少真正的 Access 自動化、Cloudflare deploy token 注入、監控平台告警接線、secret-store 輪替，以及與真實外部系統打通的全自動流水線
