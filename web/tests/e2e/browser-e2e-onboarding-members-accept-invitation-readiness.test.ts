...
const browserSpecPath = path.resolve(webDir, "tests/browser/onboarding-members-accept-invitation.smoke.spec.ts");

test("browser readiness onboarding->members->accept-invitation smoke keeps admin-readiness continuity explicit", async () => {
