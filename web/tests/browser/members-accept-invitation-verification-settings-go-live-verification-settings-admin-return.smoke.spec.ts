...
test(
  ...
  async ({ page }) => {
    ...
    const reopenVerificationLink = page.getByRole("link", { name: "Reopen verification evidence" }).first();
    await expect(reopenVerificationLink).toBeVisible();
    await reopenVerificationLink.click();
